...
const partyProfiles = [
  { name: 'Alexis Wilkinson', role: 'Matron of Honor', photo: 'portrait-1', connection: 'Lexi is Kayla\'s oldest sister.', About: 'Lexi lives in Michigan with her husband Max and dog Luna. She enjoys reading, hiking and cooking.', superlative: 'Most likely to break her shoe' },
  ...
  { name: 'Daniel Rogers', role: 'Groomsman', photo: 'portrait-8', connection: 'Daniel is Jeremy\'s brother.', About: 'Daniel lives in Missouri with his wift Ida and dog Zeke. Daniel enjoys gaming, working out and scuba diving. Daniel plans to dive around the Island leading up to the wedding!', superlative: 'Most likely to end up swimming at the reception' },
